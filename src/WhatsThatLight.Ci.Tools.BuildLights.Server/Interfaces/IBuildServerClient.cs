// <copyright file="IBuildServerClient.cs" company="What's That Light?">
...
namespace WhatsThatLight.Ci.Tools.BuildLights.Server.Interfaces
{
    ...
    /// <summary>
    /// Generic interface for a build server client. 
    /// </summary>
    public interface IBuildServerClient
    {
        ...
        /// </returns>
        IEnumerable<IBuildServerNotification> GetAllActiveBuildNotifications();
        ...
        /// Collection of <see cref="IBuildServerNotification"/>
        /// </returns>
        IEnumerable<IBuildServerNotification> GetAllBuildsThatRequireAttention();
